    ...
    <div className="px-6 xl:w-3/4 mx-auto py-10 flex flex-col gap-20 text-md">
      ...
      <div className="flex flex-col gap-20">
        ...
        <div className="flex flex-col lg:flex-row items-center w-full h-full justify-between gap-10">
          ...
          {/* composition */}
          <div className="flex flex-col gap-5 w-full h-full">
            <h3 className="text-xl font-semibold">Body Structure Analysis</h3>
            <div className="">
              <span className="mr-1">
                Your current body structure ({composition.fat_percentage}%) is
                considered
              </span>
            ...
            <Card className="bg-neutral-50 text-sm text-neutral-600 pt-3">
              <CardContent className="flex flex-col gap-2">
                ...
                <p>
                  The health result of your current body structure is calculated
                  taking into account your gender and age. This personalized
                  approach helps ensure a more accurate assessment of your
          ...
          <div className="flex flex-col gap-5 w-full h-full">
            ...
            {composition.ideal_fat >= composition.fat_percentage ? (
              <p>
                ...
                so our task is to ensure that you maintain this body
                composition.
              </p>
            ) : (
              <p>
                ...
                can work towards is {composition.ideal_fat}%.
              </p>
            )}
          </div>
        </div>
      ...
      <div className="flex flex-col gap-20">
        ...
        <div className="flex flex-col gap-5 w-full h-full">
          ...
          <p>
            {ideal_weight < data.overview.weight &&
              `To lose 0.5 kg per week, you should consume ${calory_data.lose_05} calories per day.`}
            {ideal_weight > data.overview.weight &&
              `To gain 0.5 kg per week, you should consume ${calory_data.gain_05} calories per day.`}
            {ideal_weight === data.overview.weight &&
              `To maintain your current weight, you should consume ${calory_data.calories} calories per day.`}
          </p>
          ...
          <div className="w-full hidden lg:flex flex-col gap-0 mb-10">
            <div className="w-full h-8 rounded-md shadow-md flex gap-0 text-white font-bold text-xs">
              ...
              <div className="flex items-center w-[10%] bg-green-400 h-full">
                <span className="text-center mx-auto">Maintain weight</span>
              </div>
          ...
          <div className="flex flex-col gap-5 w-full h-full">
            ...
            <div className="flex flex-col gap-1">
              ...
              <ul className="list-disc list-inside">
                ...
                <li>Seeds (e.g., chia seeds, flax seeds)</li>
