export default function getFactors({
  ...
  return (
    <div className="flex flex-col gap-6 w-full">
      <h3 className="text-xl font-semibold">Factors for Weight Loss</h3>
      ...
      <div className="flex flex-col gap-9 mt-6">
        <div className="flex gap-3 relative h-fit items-stretch">
          ...
          <div className="flex flex-col gap-2">
            <h3 className="text-lg font-medium">Nutrition - 70%</h3>
            <p>
              Nutrition plays the most important role in weight loss. About 70%
              of your success in fat burning and weight loss can be attributed
              to the food you consume. Focus on creating a calorie deficit by
              consuming nutrient-rich whole foods that are low in refined sugars
        ...
        <div className="flex gap-3 relative h-fit items-stretch">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p>
              ...
              increasing overall energy expenditure. Approximately 15% of weight
              loss success is attributed to exercise. Include a mix of
        ...
        <div className="flex gap-3 relative h-fit items-stretch">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p>
              ...
              hormones that affect appetite and metabolism. Approximately 15% of
              ...
              each night and practice stress reduction techniques such as
